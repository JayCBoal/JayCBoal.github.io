...
Glb["JobSteps"] = { # Define JobSteps here if InitJob/SkipAutoApp parameter is True
    1: {
        ...
        "FuncName": "Execute_SQL",
        "Disabled": "",
        "FuncParams": {
            "DBHost": Glb["AutomationDBHost"],
            "DBName": Glb["AutomationDBName"],
            "DBUser": Glb["AutomationDBUser"],
            "DBPwd": Glb["AutomationDBPwd"],
            "SQL": "SELECT * FROM Applications; SELECT * FROM Entities",
            "IncludeHeader": "y",
            "OutputFile": "<WorkingFolder>/SQLOutput.csv",
            "Silent": "y",
            "LogOutput": "y",
        }
    }
